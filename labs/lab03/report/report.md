...
![Установка TexLive](image/01.png){ #fig:001 width=70%, height=70% }

![Установка pandoc](image/02.png){ #fig:002 width=70%, height=70% }
...
report.docx. Откройте и проверьте корректность полученных файлов. (рис. [-@fig:003])

![Скомпилированный шаблон отчета](image/03.png){ #fig:003 width=70%, height=70% }
...
![Удалены файлы шаблона](image/02.png){ #fig:004 width=70%, height=70% }

6. Откройте файл report.md c помощью любого текстового редактора, например gedit
Внимательно изучите структуру этого файла. (рис. [-@fig:005])

![Структура шаблона](image/03.png){ #fig:005 width=70%, height=70% }
...
![Заполняем шаблон](image/04.png){ #fig:006 width=70%, height=70% }
